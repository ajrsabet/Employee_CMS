...
function mainPrompt() {
  ...
  connection.query("SELECT * FROM department", function (err, res) {
    ...
    if (departmentList.length === 0) {
      console.log("No departments have been created, you must create at least one department before adding roles or emplyees.");
      createDepartment()
      return
    };
...
function createData() {
  ...
  if (roleList.length === 0) {
    console.log("No roles have been created, you must create a role before adding an employee.");
  ...
  inquirer.prompt([{
    ...
    .then(function (res) {
      if (!rolesOnEmployees.includes(res.role_id)) {
        ...
        console.log("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
        console.log("There are still employees with this role, delete or modify these employees before deleting this role");
        console.log("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
      }  
    })
    .catch(function (err) {
    ...
    inquirer.prompt([{
      ...
      .then(function (res) {
        if (!departmentInRoles.includes(res.department)) {
          ...
          console.log("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
          console.log("There are still roles connected to this department, delete or modify these roles before deleting this department");
          console.log("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
        }
        mainPrompt();
      })
